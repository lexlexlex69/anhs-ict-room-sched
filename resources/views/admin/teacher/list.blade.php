            ...
            <table class="w-full min-w-max table-auto border border-white border-opacity-20">
                <thead class="bg-white text-gray-700 shadow border-b border-gray-300">
                    ...
                    <tr>
                        ...
                        <th class="py-3 px-4 whitespace-nowrap">Teacher Type</th> {{-- Added Teacher Type --}}
                ...
                <tbody class="divide-y divide-gray-300 text-center">
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-4 whitespace-nowrap">{{ $teacher->teacher_type }}</td> {{-- Display Teacher Type --}}
                    ...
                    @else
                    <tr>
                        <td colspan="7" class="text-center py-4 text-gray-500">No teachers found.</td> {{-- Adjusted colspan --}}
                    </tr>
                    @endif
                </tbody>
            </table>
